...
export default function Sidebar() {
  ...
  return (
    <aside
      ...
      className={`fixed top-3 left-3 bottom-3 z-50 bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04),0_4px_12px_rgba(0,0,0,0.04)] border border-black/[0.04] flex flex-col justify-between py-5 transition-all duration-300 ease-in-out ${
